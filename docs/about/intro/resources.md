...
- Ethermint: [https://github.com/kshlsa/ethermint](https://github.com/kshlsa/ethermint)
...
- [Ethermint (archive):](https://github.com/kshlsa/ethermint-archive) Precursor implementation of the current project, developed by [All in Bits Inc](https://tendermint.com/). It was aiming to implement [Erigon](https://github.com/ledgerwatch/erigon) as the EVM for scalability improvements.
